...
class MainActivity : BaseSplitActivity(), NavigationView.OnNavigationItemSelectedListener {

    private lateinit var binding: ActivityMainBinding
    lateinit var manager: SplitInstallManager
    private val moduleMaps by lazy { getString(R.string.module_feature_maps) }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_map -> {
                loadAndLaunchModule(moduleMaps)
            }
        }
        if (fragment != null) {
            supportFragmentManager.beginTransaction()
    ...
    private fun onSuccessfulLoad(moduleName: String, launch: Boolean) {
        if (launch) {
            when (moduleName) {
                moduleMaps -> launchActivity(MAPS_CLASSNAME)
                //moduleMaps -> moveToMapsActivity()
            }
        }
    }
...
private const val PACKAGE_NAME = "com.mhendrif.mytourismapp"
private const val MAPS_CLASSNAME = "$PACKAGE_NAME.maps.MapsActivity"
